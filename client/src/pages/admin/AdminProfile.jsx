...
function AdminProfile() {
  ...
  const [profileData, , error] = useFetch('/admin/admin-profile');
  const navigate = useNavigate();

  const handleLogout = async () => {
    try {
      await axiosInstance.post('/admin/admin-logout');
  ...
  return (
    <>
      ...
      <div className="heading-head d-flex justify-content-center align-items-center mt-5">
        <p className={darkMode ? "text-black" : "text-white"}>HM.com / <span className="text-danger fw-bold">Admin Account</span></p>
      </div>
      <div className="heading-head d-flex justify-content-center align-items-center mt-5">
        <p className={darkMode ? "text-black" : "text-white"} style={{ fontSize: "25px", fontWeight: "600" }}>Admin Account</p>
      </div>
        <div className="d-flex justify-content-center flex-column flex-lg-row align-items-center" style={{ gap: "20px" }}>
          <Container data-theme={darkMode ? "dark" : "light"}>
            <div className="d-flex justify-content-center align-items-center mt-4" style={{ position: "relative", width: "100%", flex: "1 1 auto" }}>
              <img src="https://about.hm.com/content/dam/hmabout/groupsite/images/article/2023/august/1008-article-image-1952x1206.jpg/jcr:content/renditions/cq5dam.web.976.603.jpeg" style={{ width: "100%", maxWidth: "600px", objectFit: "cover" }} />
