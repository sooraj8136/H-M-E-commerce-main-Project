...
// import { axiosInstance } from '../../config/axiosInstance'; // Make sure you have axiosInstance configured
// import toast from 'react-hot-toast';

// function SellerProductDetails() {
//   const { darkMode } = useSelector((state) => state.mode); // Access dark mode from Redux state
//   const { productId } = useParams(); // Get the productId from the URL
//   const navigate = useNavigate(); // Use to navigate after deletion

//   const [product, error] = useFetch(`/product/get-product/${productId}`); // Fetch product details

//   const handleDeleteProduct = async () => {
//     try {
//       const response = await axiosInstance.delete(`/product/delete-product/${productId}`);
//       toast.success('Product deleted successfully');
//       navigate('/seller/product'); // Redirect to the seller products page after deletion
//     } catch (error) {
//       console.log(error);
