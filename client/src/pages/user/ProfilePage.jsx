        ...
        <>
          ...
          <Container data-theme={darkMode ? "dark" : "light"}>
            <div className="d-flex justify-content-start align-items-start flex-column flex-lg-row" style={{ gap: "20px", marginTop: "30px" }}>
              ...
              <div style={{ flex: '1', maxWidth: '400px', marginBottom: '20px' }}>
                <img
                  src="https://image.hm.com/content/dam/ns-april-mip-and-account/Top%20header%20MIP%20april%20NS.jpg?imwidth=1536"
                  alt="Profile"
                  style={{
                    width: '100%',
                    height: 'auto',
                ...
                <div className="lines-container">
                  <div className="line-section d-flex align-items-center justify-content-between w-100 my-2">
                    <div className="d-flex align-items-center" style={{ flexGrow: 1 }}>
                      <Link
                        to="/user/orders"
                        className={`${darkMode ? "text-dark" : "text-light"} link-underline navlink-font`}
                  ...
                  <Link
                    ...
                    className={`navlink-font link-underline ${darkMode ? "text-dark" : "text-light"}`}
                  ...
                  <div className="line-section d-flex align-items-center justify-content-between w-100 my-2">
                    <div className="d-flex align-items-center" style={{ flexGrow: 1, fontSize: "1.2rem" }}>
                      <span
                        className="navlink-font link-underline"
